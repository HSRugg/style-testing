...
var make_line_for_state = function(state) {
    ...
    line_plot_one  = document.createElement("div");
    line_plot_one.setAttribute("id", "line_plot_one");
    line_plot_one.style.height = 1000;
    line_plot_one.style.width = 1000;
    line_plot_one.style.paddingTop = "100px"
    document.body.appendChild(line_plot_one);
